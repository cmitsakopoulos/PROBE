...
querydatapath = os.path.join(pathdictionary["App-Files"], "querygenes2.json")
resultsoutput = pathdictionary["BLAST-Search-Results"]
databasedirectory = pathdictionary["BLAST-Databases"]
print("> Module two in operation...")
x=0
...
if not x == 0:
    ...
    print("> Module two finished operations, receipt printed in RESULTS.")
else:
